  ...
  return (
    <div className="flex min-h-screen bg-black text-white">
      ...
      <div className="flex-1 px-4 py-12 flex flex-col items-start justify-start">
        ...
        <p className="mb-8 text-base text-gray-300">Here are my contact details. If you want something quick, use Discord.</p>
        ...
        <div className="w-full max-w-md mb-10">
          ...
          <p className="mb-2 text-gray-300">If you want to send me a secret: <a href="/lucasof.gpg" className="text-indigo-400 hover:underline">lucasof.gpg</a></p>
        ...
        <div className="w-full max-w-md mb-10">
          <h2 className="text-xl font-semibold mb-2">Crypto</h2>
            <p className="mb-2 text-gray-300">If you want to buy me a coffee ☕ in crypto for some reason:</p>
          <div className="bg-gray-900 rounded p-4 text-sm font-mono break-all border border-gray-700">bc1qrfzjxcf49cnhpcawtqdggds5t39s4ms5xhjfkh</div>
        </div>
