  ...
  return (
    <Layout>
      ...
      <header className="mb-12">
        <time className="text-sm font-mono text-blue-500/80 mb-2 block">
          {formattedDate}
        </time>
          ...
          components={{
            ...
            code: ({ inline, children, ...props }: any) => {
              return inline ? (
                ...
                <pre className="bg-gray-950 border border-gray-800 p-4 rounded-xl overflow-x-auto my-8 shadow-lg">
                  <code className="text-sm text-gray-200 font-mono leading-relaxed" {...props}>
                    {children}
                  </code>
                </pre>
              );
            ...
            blockquote: ({ ...props }) => (
              <blockquote className="border-l-4 border-blue-500 bg-blue-500/5 p-6 rounded-r-lg italic my-8" {...props} />
            ),
            img: ({ ...props }) => (
              <span className="block my-10">
                <img className="rounded-2xl border border-gray-800 shadow-2xl mx-auto" {...props} />
                {props.alt && <span className="block text-center text-sm text-gray-500 mt-3">{props.alt}</span>}
              </span>
            ),
          }}
        >
